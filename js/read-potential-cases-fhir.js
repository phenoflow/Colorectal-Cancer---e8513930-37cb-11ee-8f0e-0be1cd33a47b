...
(async () => {
  ...
  await fs.writeFile("colorectal-cancer-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("colorectal-cancer-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
